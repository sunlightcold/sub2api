	...
	m, err := r.activeQuery().
		...
		WithGroup(func(q *dbent.GroupQuery) {
			q.Select(
				...
				group.FieldImageBillingUseRequestedCount,
				...
				group.FieldDisableResponsesAPI,
				group.FieldDisableChatCompletionsAPI,
...
func groupEntityToService(g *dbent.Group) *service.Group {
	...
	return &service.Group{
		...
		ImageBillingUseRequestedCount:   g.ImageBillingUseRequestedCount,
		...
		DisableResponsesAPI:             g.DisableResponsesAPI,
		DisableChatCompletionsAPI:       g.DisableChatCompletionsAPI,
