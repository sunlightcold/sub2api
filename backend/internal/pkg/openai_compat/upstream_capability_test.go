...
func TestShouldRouteResponsesViaChatCompletions(t *testing.T) {
	tests := []struct {
		...
		{"preserve chat endpoint does not convert responses despite unsupported probe", map[string]any{ExtraKeyResponsesMode: string(ResponsesSupportModePreserveChatEndpoint), ExtraKeyResponsesSupported: false}, false},
		{"preserve chat endpoint does not convert responses with supported probe", map[string]any{ExtraKeyResponsesMode: string(ResponsesSupportModePreserveChatEndpoint), ExtraKeyResponsesSupported: true}, false},
	}
