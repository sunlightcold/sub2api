...
const apiKeyAuthSnapshotVersion = 20 // v20: merge endpoint/profit controls with search, audio, and video-model billing fields
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			ImageBillingUseRequestedCount:   apiKey.Group.ImageBillingUseRequestedCount,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			ImageBillingUseRequestedCount:   snapshot.Group.ImageBillingUseRequestedCount,
