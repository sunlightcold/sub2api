...
func TestBufferRawChatCompletions_RejectsOversizedResponse(t *testing.T) {
	...
	result, err := svc.bufferRawChatCompletionsWithCorrection(c.Request.Context(), c, resp, rawChatCompletionsTestAccount(), "gpt-5.4", "gpt-5.4", "gpt-5.4", nil, nil, time.Now(), nil)
