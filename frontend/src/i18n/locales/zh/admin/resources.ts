export default {
    ...
    usage: {
      ...
      upstreamTiming: '上游耗时',
      upstreamTimingDetails: '上游耗时详情',
      upstreamTimingPhaseDetails: '阶段耗时',
      upstreamTimingEndToEndDetails: '端到端耗时',
      upstreamTimingForwardShort: '转发',
      upstreamTimingTotalShort: '总计',
      upstreamTimingTTFTShort: '首包',
      upstreamTimingHeadersShort: '响应头',
      upstreamTimingPostHeadersShort: '头后',
      upstreamTimingGatewayPrepare: '网关准备',
      upstreamTimingHeaders: '等待响应头',
      upstreamTimingUpstreamFirstSSE: '响应头到首包',
      upstreamTimingGatewayFirstOutput: '首包到输出',
      upstreamTimingGeneration: '首包到终止事件',
      upstreamTimingStreamTail: '终止事件到流结束',
      upstreamTimingPostHeaders: '响应头后',
      ...
      cleanup: {
        ...
        dateRange: '清理时间范围',
        timeRange: '清理时间范围（精确到秒）',
        startTime: '开始时间',
        endTime: '结束时间',
        estimateTitle: '预计清理数量',
        estimate: '计算数量',
        estimating: '计算中...',
        estimateNotCalculated: '尚未计算',
        estimateResult: '匹配 {count} 条记录',
        estimateHint: '数量按当前筛选条件实时计算，提交前数据仍可能发生变化。',
        estimateFailed: '计算清理数量失败',
        submit: '提交清理',
        submitting: '提交中...',
        confirmTitle: '确认清理',
        confirmMessage: '确定要提交清理任务吗？清理不可恢复。',
        confirmMessageWithCount: '当前筛选条件预计清理 {count} 条记录。确定提交吗？清理不可恢复。',
        confirmSubmit: '确认清理',
        cancel: '取消任务',
