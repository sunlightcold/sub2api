export default {
    ...
    groups: {
      ...
      form: {
        ...
        platform: '平台',
        rateMultiplier: '费率倍数',
        longContextPricing: '长上下文阶梯计费',
        longContextPricingHint: '关闭时忽略模型价格中的长上下文阈值与倍率，始终使用当前服务档位的基础 Token 单价；开启后才允许 272K 等阶梯规则生效。',
        longContextPricingEnabled: '已启用长上下文阶梯价',
        longContextPricingDisabled: '已关闭，使用基础 Token 单价',
        status: '状态',
        exclusive: '专属分组',
        nameLabel: '分组名称',
