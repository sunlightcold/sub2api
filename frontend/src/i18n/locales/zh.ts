  ...
  admin: {
    ...
    accounts: {
      ...
      openai: {
        ...
        responsesModeDesc:
          '仅对 OpenAI API Key 的文本转发链路生效。自动跟随探测结果；保持 Chat 端点只禁止 Chat Completions 转 Responses；保持入站端点会禁止双向跨协议转换；强制模式会覆盖自动探测。',
        responsesModeAuto: '自动',
        responsesModePreserveChatEndpoint: '保持 Chat 端点',
        responsesModePreserveEndpoint: '保持入站端点',
    ...
    usage: {
      ...
      ipAddress: 'IP',
      upstreamTiming: '上游耗时',
      upstreamTimingDetails: '上游耗时明细',
      upstreamTimingPhaseDetails: '阶段耗时',
      upstreamTimingEndToEndDetails: '端到端耗时',
      upstreamTimingForwardShort: '总',
      upstreamTimingTotalShort: '总',
      upstreamTimingTTFTShort: '首 SSE',
      upstreamTimingHeadersShort: '响应头',
      upstreamTimingPostHeadersShort: '响应体',
      upstreamTimingGatewayPrepare: '网关准备',
      upstreamTimingHeaders: '等待响应头',
      upstreamTimingUpstreamFirstSSE: '响应头到首 SSE',
      upstreamTimingGatewayFirstOutput: '首 SSE 到出站',
      upstreamTimingGeneration: '首 SSE 到终止',
      upstreamTimingStreamTail: '终止到流结束',
      upstreamTimingPostHeaders: '响应头后处理',
      upstreamTimingTTFT: '首 SSE 总耗时',
      upstreamTimingClientTTFT: '首出站总耗时',
      upstreamTimingTotal: '总耗时(原始)',
