  ...
  admin: {
    ...
    accounts: {
      ...
      openai: {
        ...
        responsesModeDesc:
          'Only applies to OpenAI API Key accounts. Auto follows probe results; preserve Chat endpoint only prevents Chat Completions from converting to Responses, while preserve endpoint disables conversion in both directions.',
