export default {
    ...
    usage: {
      ...
      upstreamTiming: 'Upstream Timing',
      upstreamTimingDetails: 'Upstream Timing Details',
      upstreamTimingPhaseDetails: 'Phase timings',
      upstreamTimingEndToEndDetails: 'End-to-end timings',
      upstreamTimingForwardShort: 'Forward',
      upstreamTimingTotalShort: 'Total',
      upstreamTimingTTFTShort: 'First SSE',
      upstreamTimingHeadersShort: 'Headers',
      upstreamTimingPostHeadersShort: 'Post-headers',
      upstreamTimingGatewayPrepare: 'Gateway prepare',
      upstreamTimingHeaders: 'Wait for headers',
      upstreamTimingUpstreamFirstSSE: 'Headers to first SSE',
      upstreamTimingGatewayFirstOutput: 'First SSE to output',
      upstreamTimingGeneration: 'First SSE to terminal',
      upstreamTimingStreamTail: 'Terminal to stream end',
      upstreamTimingPostHeaders: 'After headers',
      ...
      cleanup: {
        ...
        dateRange: 'Cleanup Date Range',
        timeRange: 'Cleanup Time Range (to the second)',
        startTime: 'Start time',
        endTime: 'End time',
        estimateTitle: 'Estimated Cleanup',
        estimate: 'Calculate Count',
        estimating: 'Calculating...',
        estimateNotCalculated: 'Not calculated yet',
        estimateResult: '{count} matching records',
        estimateHint: 'The count uses the current filters and may change before submission.',
        estimateFailed: 'Failed to calculate cleanup count',
        ...
        confirmMessageWithCount: 'The current filters match approximately {count} records. Submit this irreversible cleanup task?',
