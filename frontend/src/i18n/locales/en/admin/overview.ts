export default {
    ...
    groups: {
      ...
      form: {
        ...
        platform: 'Platform',
        rateMultiplier: 'Rate Multiplier',
        longContextPricing: 'Long-context tier pricing',
        longContextPricingHint: 'When disabled, model-defined long-context thresholds and multipliers are ignored and the current service tier base token prices are always used. Enable it only for groups that should apply tiers such as 272K.',
        longContextPricingEnabled: 'Long-context tier pricing enabled',
        longContextPricingDisabled: 'Disabled; using base token prices',
        status: 'Status',
